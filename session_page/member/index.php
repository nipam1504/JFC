...
<a class="btn btn-primary btn-block" href="./../../modules/selectCamp.php"> <span class="glyphicon glyphicon-flag"></span> Camp </a>
<br>
</div>
<div style="padding-top:10px; padding-right:300px; padding-left:300px; padding-bottom:30px;">
<a class="btn btn-primary btn-block" href="./../../modules/suggestion.php"> <span class="glyphicon glyphicon-pencil"></span> Suggestion Box </a>
<br>
</div>
</body>
</html>